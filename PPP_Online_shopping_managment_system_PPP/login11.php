...
$id = $pw = $remember = "";
$idErr = $pwErr = $pwErr1 = $idErr1 = $validErr = "";
$goto=0;
...
if($userid->num_rows >0){
	...
	if($userpw->num_rows >0){
		$uservalid=mysqli_query($conn,"select validity from users where userid='$id' and  pw='$pw' and validity=1");
		if($uservalid->num_rows >0){
			...
			$validErr = "This account is invalid or hasn't been approved (admin) yet";
		}
	}else{
...
<div class="display">
					...
					<span class="err">	<?php echo $validErr;?> </span>
