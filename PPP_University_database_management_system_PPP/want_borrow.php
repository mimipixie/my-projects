...
<h1><center> You Can Borrow </center></h1>
...
<?php
    ...
    function Valid($Information)
	{
		...
		return $Information;
		 ...
		 $query="select * from books where student='N/A' and borrow=11 and borrowed=0 " ;
		  ...
		  $Result=mysqli_query($connection,$query);
			  ...
			  if(mysqli_num_rows($Result)>0)
			  {
				...
				echo "<td>"; ?> <a href="<?php echo $str;?>"><img src='borrow.jpg'  width='80px' height='50px'/></a>	 <?php echo "</td>";
				echo "</td>";
